mob/human/player/npc
	...
	Konoha_Guard
		...
		message ="..."
		delay=2
		skillsx=list(KAWARIMI,WINDMILL_SHURIKEN,SHUNSHIN,BUNSHIN,KATON_FIREBALL,LEAF_GREAT_WHIRLWIND,NIRVANA_FIST,EXPLODING_KUNAI,KATON_PHOENIX_FIRE)
	...
	Suna_Guard
		...
		message ="..."
		delay=2
		skillsx=list(KAWARIMI,WINDMILL_SHURIKEN,SHUNSHIN,BUNSHIN,FUUTON_GREAT_BREAKTHROUGH,FUUTON_WIND_BLADE,EXPLODING_KUNAI)
	Mist_Guard
		nisguard=1
		//village="Kiri"
		name="Mist Guard"
		...
		message ="..."
		delay=2
		skillsx=list(KAWARIMI,WINDMILL_SHURIKEN,SHUNSHIN,BUNSHIN,SUITON_VORTEX,EXPLODING_KUNAI)
	Konoha_Civ1
		locationdisc="Konoha"
		name="Kotamaru"
		wander=0
