...
proc
	initialize_basic_factions()
		...
		faction_info = params2list(SendInterserverMessage("faction_info", list("faction" = "Konohagakure")))
		...
		faction_info = params2list(SendInterserverMessage("faction_info", list("faction" = "Kirigakure")))
		...
		faction_info = params2list(SendInterserverMessage("faction_info", list("faction" = "Sunagakure")))
		...
		faction_info = params2list(SendInterserverMessage("faction_info", list("faction" = "Missing")))
