...
obj
	Blank_Slot
		...
		Slot5
			pixel_x=1
			im=list('CreationScreen/clan/clan-akimichi.png',null,null,null,null,null)
			aim=list('CreationScreen/clan/clan-akimichiS.png',null,null,null,null,null)
			ind=list("Akimichi",null,null,null,null,"")
		Slot6
			pixel_x=-16
			im=list(null,null,null,null,null,null)
			aim=list(null,null,null,null,null,null)
