turf
	...
	ATEXTURA
		Terra
			Terra
				icon = 'texturas/terra/ATerra.dmi'
				icon_state = "terra"
			BordaA
				icon = 'texturas/terra/ATerraBordaA.dmi'
				icon_state = "terraboraa"
			BordaB
				icon = 'texturas/terra/ATerraBordaB.dmi'
				icon_state = "terrabordab"
			BordaC
				icon = 'texturas/terra/ATerraBordaC.dmi'
				icon_state = "terrabordac"
			BordaD
				icon = 'texturas/terra/ATerraBordaD.dmi'
				icon_state = "terrabordad"
			BordaE
				icon = 'texturas/terra/ATerraBordaE.dmi'
				icon_state = "terraborae"
			BordaF
				icon = 'texturas/terra/ATerraBordaF.dmi'
				icon_state = "terrabordaf"
			BordaG
				icon = 'texturas/terra/ATerraBordaG.dmi'
				icon_state = "terrabordag"
			BordaH
				icon = 'texturas/terra/ATerraBordaH.dmi'
				icon_state = "terrabordah"

		Grama
			Grama
				icon = 'texturas/grama/AGrama.dmi'
				icon_state = "grama"
			BordaA
				icon = 'texturas/grama/AGramaBordaA.dmi'
				icon_state = "gramaboraa"
			BordaB
				icon = 'texturas/grama/AGramaBordaB.dmi'
				icon_state = "gramabordab"
			BordaC
				icon = 'texturas/grama/AGramaBordaC.dmi'
				icon_state = "gramabordac"
			BordaD
				icon = 'texturas/grama/AGramaBordaD.dmi'
				icon_state = "gramabordad"
			BordaE
				icon = 'texturas/grama/AGramaBordaE.dmi'
				icon_state = "gramaborae"
			BordaF
				icon = 'texturas/grama/AGramaBordaF.dmi'
				icon_state = "gramabordaf"
			BordaG
				icon = 'texturas/grama/AGramaBordaG.dmi'
				icon_state = "gramabordag"
			BordaH
				icon = 'texturas/grama/AGramaBordaH.dmi'
...
turf
	...
	Mmountain
		icon = 'turfsnone.dmi'
		icon_state = "Mountain Top"
		density = 1
	Mmountain1
		icon = 'turfsnone.dmi'
		icon_state = "Mountain Bottom"
		density = 1
	Mmountain2
		icon = 'turfsnone.dmi'
		icon_state = "Mountain"
	...
	UzumakiE//usr.loc = locate(x,y,4)
		...
		Enter(A)
			if(ismob(A))
				...
				if(istype(A,/obj/)) del(A)
	UzumakiEXIT//usr.loc = locate(x,y,4)
		icon = 'Landscapes.dmi'
		icon_state = "openwall"
		density = 0
		Enter(A)
	...
	StarTrainingRoomEXIT//usr.loc = locate(x,y,4)
		icon = 'StarTrainingRoom.dmi'
		icon_state = "TrainingRoom2"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(7,16,31)
			else
				if(istype(A,/obj/)) del(A)
	RockTraining//usr.loc = locate(x,y,4)
		icon = 'RockTraining.dmi'
		icon_state = "RockTraining"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(62,2,10)
			else
				if(istype(A,/obj/)) del(A)
	RockTrainingExit//usr.loc = locate(x,y,4)
		icon = 'RockTraining.dmi'
		icon_state = "RockTraining2"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(86,53,7)
			else
				if(istype(A,/obj/)) del(A)
	LTraining//usr.loc = locate(x,y,4)
		icon = 'LTraining.dmi'
		icon_state = "LTraining"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(89,65,15)
			else
				if(istype(A,/obj/)) del(A)
	LTrainingExit//usr.loc = locate(x,y,4)
		icon = 'LTraining.dmi'
		icon_state = "LTraining2"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(67,49,8)
			else
				if(istype(A,/obj/)) del(A)
	WFTraining//usr.loc = locate(x,y,4)
		icon = 'WFTraining.dmi'
		icon_state = "WFTraining"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				...
				if(istype(A,/obj/)) del(A)
	WFTrainingExit//usr.loc = locate(x,y,4)
		icon = 'WFTraining.dmi'
		icon_state = "WFTraining2"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(8,57,24)
			else
				if(istype(A,/obj/)) del(A)
	UchiE//usr.loc = locate(x,y,4)
		icon = 'waller.dmi'
		icon_state="fwall1"
		density = 0
		Enter(A)
	...
	UchiEXIT//usr.loc = locate(x,y,4)
		...
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(74,54,3)
			else
				if(istype(A,/obj/)) del(A)
	HakuE//usr.loc = locate(x,y,4)
		icon = 'waller.dmi'
		icon_state="fwall1"
		density = 0
		Enter(A)
	...
	HakuEXIT//usr.loc = locate(x,y,4)
		...
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(65,60,27)
			else
				if(istype(A,/obj/)) del(A)



	BeeE//usr.loc = locate(x,y,4)
		icon = 'waller.dmi'
		icon_state="fwall1"
		density = 0
		Enter(A)
	...
	AkimichiE//usr.loc = locate(x,y,4)
		...
		Enter(A)
			if(ismob(A))
				...
				if(istype(A,/obj/)) del(A)
	AkimichiEXIT//usr.loc = locate(x,y,4)
		icon = 'Landscapes.dmi'
		icon_state = "openwall"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(43,53,24)
			else
				if(istype(A,/obj/)) del(A)

	AburameE//usr.loc = locate(x,y,4)
		icon = 'waller.dmi'
		icon_state="fwall1"
		density = 0
		Enter(A)
			if(ismob(A))
				...
				if(istype(A,/obj/)) del(A)
	AburameEXIT//usr.loc = locate(x,y,4)
		icon = 'Landscapes.dmi'
		icon_state = "openwall"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(79,78,4)
			else
				if(istype(A,/obj/)) del(A)

	NaraE//usr.loc = locate(x,y,4)
		icon = 'waller.dmi'
		icon_state="fwall1"
		density = 0
		Enter(A)
	...
	NaraEXIT//usr.loc = locate(x,y,4)
		...
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(17,27,9)
			else
				if(istype(A,/obj/)) del(A)

	KaguyaE//usr.loc = locate(x,y,4)
		icon = 'waller.dmi'
		icon_state="fwall1"
		density = 0
		Enter(A)
			if(ismob(A))
				...
				if(istype(A,/obj/)) del(A)
	KaguyaEXIT//usr.loc = locate(x,y,4)
		icon = 'Landscapes.dmi'
		icon_state = "openwall"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(61,56,6)
			else
				if(istype(A,/obj/)) del(A)

	InuzukaE//usr.loc = locate(x,y,4)
		icon = 'waller.dmi'
		icon_state="fwall1"
		density = 0
		Enter(A)
			if(ismob(A))
				...
				if(istype(A,/obj/)) del(A)
	InuzukaEXIT//usr.loc = locate(x,y,4)
		icon = 'Landscapes.dmi'
		icon_state = "openwall"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(38,20,8)
			else
				if(istype(A,/obj/)) del(A)
	GaaraE//usr.loc = locate(x,y,4)
		icon = 'waller.dmi'
		icon_state="fwall1"
		density = 0
		Enter(A)
			if(ismob(A))
				...
				if(istype(A,/obj/)) del(A)
	GaaraEXIT//usr.loc = locate(x,y,4)
		icon = 'Landscapes.dmi'
		icon_state = "openwall"
		density = 0
		Enter(A)
	...
	TentenE//usr.loc = locate(x,y,4)
		...
		Enter(A)
			if(ismob(A))
				...
				if(istype(A,/obj/)) del(A)
	TentenEXIT//usr.loc = locate(x,y,4)
		icon = 'Landscapes.dmi'
		icon_state = "openwall"
		density = 0
		Enter(A)
	...
	ArenaEXIT//usr.loc = locate(x,y,4)
		icon = 'Landscapes.dmi'
		icon_state = "openwall"
		density = 0
		Enter(A)
	...
	Leafacadenter//usr.loc = locate(x,y,4)
		...
		Enter(A)
			if(ismob(A))
				...
				var/mob/M = A
				if(M.client)
					M.loc = locate(81,39,2)
			else
				if(istype(A,/obj/)) del(A)
	waterfallacadenter
		icon = 'WFChuunin.dmi'
		icon_state = "WFChuunin"
		density = 0
		Enter(A)
			if(ismob(A))
				if(usr.density==0)
	...
	RainTraining//usr.loc = locate(x,y,4)
		icon = 'RainTraining.dmi'
		icon_state = "RainTraining"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(11,2,29)
			else
				if(istype(A,/obj/)) del(A)
	RainTrainingEXIT//usr.loc = locate(x,y,4)
		icon = 'RainTraining.dmi'
		icon_state = "RainTraining2"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(21,18,4)
			else
				if(istype(A,/obj/)) del(A)
	STraining//usr.loc = locate(x,y,4)
		icon = 'STraining.dmi'
		icon_state = "STraining"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(53,27,28)
			else
				if(istype(A,/obj/)) del(A)
	STrainingEXIT//usr.loc = locate(x,y,4)
		icon = 'STraining.dmi'
		icon_state = "STraining2"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(46,42,27)
			else
				if(istype(A,/obj/)) del(A)
	SandTraining//usr.loc = locate(x,y,4)
		icon = 'SandTraining.dmi'
		icon_state = "SandTraining"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(17,19,25)
			else
				if(istype(A,/obj/)) del(A)
	SandTrainingEXIT//usr.loc = locate(x,y,4)
		icon = 'SandTraining.dmi'
		icon_state = "SandTraining2"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(11,75,5)
			else
				if(istype(A,/obj/)) del(A)
	petplace//usr.loc = locate(x,y,4)
		icon = 'petplace.dmi'
		icon_state = "petplace"
		density = 0
		Enter(A)
			if(ismob(A))
				...
				if(istype(A,/obj/)) del(A)
	petplaceEXIT//usr.loc = locate(x,y,4)
		icon = 'petplace.dmi'
		icon_state = "petplace2"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(27,41,1)
			else
				if(istype(A,/obj/)) del(A)
	SoundTraining//usr.loc = locate(x,y,4)
		icon = 'SaoundTrainging.dmi'
		icon_state = "SoundTraining"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(17,66,16)
			else
				if(istype(A,/obj/)) del(A)
	SoundTrainingEXIT//usr.loc = locate(x,y,4)
		icon = 'SaoundTrainging.dmi'
		icon_state = "SoundTraining2"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(28,26,6)
			else
				if(istype(A,/obj/)) del(A)
	StoreExit//usr.loc = locate(x,y,4)
		icon = 'Store.dmi'
		icon_state = "StoreExit"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(38,55,6)
			else
				if(istype(A,/obj/)) del(A)
	Store//usr.loc = locate(x,y,4)
		icon = 'Store.dmi'
		icon_state = "Store"
		density = 0
		Enter(A)
...
turf
	...
	doorfromacadkonoha
		...
		Enter(A)
			if(ismob(A))
				...
				if(istype(A,/obj/)) del(A)
	doorfromacadstar
		icon = 'StarAcadDoor.dmi'
		icon_state="StarAcad2"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(43,83,31)
			else
				if(istype(A,/obj/)) del(A)
	doorfromacadsound
		icon = 'Landscapes.dmi'
	...
	doorfromacadwaterfall
		icon = 'WFChuunin.dmi'
		icon_state="WFChuuninEXIT"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(58,36,24)
			else
				if(istype(A,/obj/)) del(A)
		...
		Enter(A)
			if(ismob(A))
				...
				if(M.client)
					...
					M.firing = 0
					(M) << sound(null)
					M<<'Naruto main theme.mid'
			else
				if(istype(A,/obj/)) del(A)

	Snowacadenter//usr.loc = locate(x,y,4)
		icon = 'Landscapes.dmi'
		icon_state = "openwall"
		density = 0
		Enter(A)
			if(ismob(A))
				...
				var/mob/M = A
				if(M.client)
					M.loc = locate(28,40,28)
			else
				if(istype(A,/obj/)) del(A)

	Snowacadexit//usr.loc = locate(x,y,4)
		icon = 'Landscapes.dmi'
		icon_state = "openwall"
		density = 0
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc = locate(13,56,27)
			else
				if(istype(A,/obj/)) del(A)
	Staracadenter//usr.loc = locate(x,y,4)
		icon = 'StarAcadDoor.dmi'
		icon_state = "StarAcad"
		density = 0
		Enter(A)
	...
	chuunin
		Entered(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					if(M.Mtai >=1250&&M.Mnin>=1250&&M.Mgen>=1250 &&M.rank=="Genin")
						M.bchuuninx = M.x
						M.bchuuniny = M.y
						M.bchuuninz = M.z
...
turf
	...
	wmansionOUT
		...
		opacity = 1
		Enter()
			usr.loc=locate(60,50,24)

	rmansionIN
		icon = 'mansionrain.dmi'
		icon_state = "28"
		density = 1
		Enter()
			usr.loc=locate(80,50,25)
	rmansion1
		icon = 'mansionrain.dmi'
		icon_state = "1"
		density = 1
	...
	imansionOUT
		...
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.client)
					M.loc=locate(45,48,31)
			else
				if(istype(A,/obj/)) del(A)

	somansionIN
		icon = 'mansionsound.dmi'
		icon_state = "28"
		density = 1
		Enter(A)
			if(ismob(A))
...
turf
	LEAVEFOREST
		...
		Enter(A)
			if(ismob(A))
				var/mob/M = A
				if(M.heavenscroll==1&&M.earthscroll==1)
